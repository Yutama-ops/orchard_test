							...
							<div class="col-12 col-md-6 col-lg-4 post-container">
								<a href="${post.readMoreLink}" aria-label="Read more about ${post.title}">
									<article class="post-entry">
										<img src="${post.image.src}" onerror="this.src='/web/app/themes/orchard-theme/assets/src/img/orchard_logo.jpeg';" class="w-100 border-danger border-bottom border-5 mb-1 mb-md-2" alt="${post.image.alt}">
